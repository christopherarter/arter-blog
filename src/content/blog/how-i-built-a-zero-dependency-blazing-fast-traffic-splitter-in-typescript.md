...
![Diagram of Queue A filled with weighted items and an empty Queue B](/images/1737473617712-PonMoXbIa.png)

When the splitter routes traffic, it pulls the item from Queue A and puts it into Queue B.

![Diagram showing an item moved from Queue A into Queue B](/images/1737473618023-BKNKmtCV-.png)
...
![Diagram of single-queue index approach with a cursor tracking current position](/images/1737473618286-s9MRxdqcB.png)
