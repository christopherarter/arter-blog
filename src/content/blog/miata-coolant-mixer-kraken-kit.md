...
I noticed that the coolant mixer housing was interfering with the turbo.

Photo of the issue:

<div class="flex justify-center">
  <img
    src="/images/miata-kraken-lowmount.jpg"
    alt="Kraken Kit"
    width="500"
    class="w-1/2 h-auto"
  />
...
Photo of the modification:

<div class="flex justify-center">
  <img
    src="/images/modified-miata-coolant-mixer.jpg"
    alt="Modified Miata Coolant Mixer"
    width="500"
    class="w-1/2 h-auto"
  />
</div>

Be sure to use a sanding disc or something to smooth out the edges so it doesn't
slice the coolant tube.
